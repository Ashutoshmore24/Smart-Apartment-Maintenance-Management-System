...
('Lift B', 'Mechanical', 'Otis', 'Working', 'Block A', 1),
('Generator 1', 'Electrical', 'Cummins', 'Working', 'Basement', 1),
('Water Pump', 'Plumbing', 'Kirloskar',  'Working', 'Pump Room', 1),
('CCTV System', 'Security', 'Hikvision', 'Working', 'Main Gate', 1);
