...
const PaymentPage = () => {
    ...
    return (
        <div className="max-w-6xl px-6 py-12 mx-auto">
            ...
            {/* Recent Payments (NOW ABOVE EVERYTHING) */}
            <div className="mb-10">
            ...
            <div className="grid items-start grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-6 lg:col-span-2">
                    ...
                    {bills.length === 0 && (
                        <div className="p-8 text-center border border-gray-300 border-dashed bg-gray-50 rounded-xl dark:bg-gray-800 dark:border-gray-700">
